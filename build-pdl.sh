...
javac -classpath ${HADOOP_HOME}/$hadoop -d dsgd_classes/ DSGD.java DSGDMapper.java DSGDReducer.java Tensor.java SparseTensor.java DenseTensor.java TensorMultipleOutputFormat.java Matrix.java DSGDMapperPaired.java DSGDPartitioner.java KeyComparator.java GroupComparator.java IntArray.java FloatArray.java
...
javac -classpath ${HADOOP_HOME}/$hadoop -d frobenius_classes/ Frobenius.java DSGDMapper.java Tensor.java SparseTensor.java DenseTensor.java TensorMultipleOutputFormat.java Matrix.java DSGDMapperPaired.java DSGDPartitioner.java KeyComparator.java GroupComparator.java IntArray.java FloatArray.java
